    ...
    return (
        <Form onSubmit={handleSubmit(onSubmit)}>
            <div className="form-group">
                <input id="name" className={LoginInputStyling.input} type="text" name="username"  required ref={register({required: true, maxLength: 20})}/>
                ...
                <label htmlFor="name" className={LoginInputStyling.input_label}><span className={LoginInputStyling.input_text}>Username</span></label>
            </div>
            <div className="form-group">
                <input id="password" className={LoginInputStyling.input} type="password" name="password" required ref={register({required: true, maxLength: 20})}/>
